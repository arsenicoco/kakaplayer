...
echo "==> VLCKit";            [[ -d app/Packages/VLCKitBinary/VLCKit.xcframework/macos-arm64_x86_64 \
                                 && -d app/Packages/VLCKitBinary/VLCKit.xcframework/ios-arm64 ]] || scripts/fetch-vlckit.sh
